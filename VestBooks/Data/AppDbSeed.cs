...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder)
    {
        ...
        List<Autor> autores = new()
        {
            ...
            new Autor { Id = 14, Nome = "Ailton Krenak" },
            new Autor { Id = 15, Nome = "Lima Barreto" },
            new Autor { Id = 16, Nome = "Chimamanda Ngozi Adichie" },
            new Autor { Id = 17, Nome = "Caio Fernando Abreu" },
            new Autor { Id = 18, Nome = "Cartola" },
            new Autor { Id = 19, Nome = "Lewis Carroll" },
            new Autor { Id = 20, Nome = "Djamilia Pereira de Almdeida" },
            new Autor { Id = 21, Nome = "Lygia Fagundes Telles" },
            new Autor { Id = 22, Nome = "Paulina Chiziane" },
            new Autor { Id = 23, Nome = "Rachel de Queiroz" },
            new Autor { Id = 24, Nome = "Conceição Evaristo" },
            new Autor { Id = 25, Nome = "Julia Lopes de Almeida" },
            new Autor { Id = 26, Nome = "Narcisa Amália" },
            new Autor { Id = 27, Nome = "Sophia de Mello Breyner Andresen" },
            new Autor { Id = 28, Nome = "Nísia Floresta" },
    ...
    new Livro { Id = 17, FaculdadeId = 2, Nome = "A vida não é útil", Descricao = "é um livro que questiona o sistema capitalista, o consumismo e a destruição ambiental. Composto por cinco textos: Não se come dinheiro, Sonhos para adiar o fim do mundo, A máquina de fazer coisas, O amanhã não está à venda, A vida não é útil.", Publicacao = "2020", AutorId = 14, Avaliacao= "4,8", Destaque = true },
    new Livro { Id = 18, FaculdadeId = 2, Nome = "Casa Velha", Descricao = "Casa Velha é um romance de Machado de Assis que aborda temas como o poder das normas sociais, a ascensão social e as relações de poder entre as classes sociais", Publicacao = "1886", AutorId = 2, Avaliacao = "4,6", Destaque = true },
    new Livro { Id = 19, FaculdadeId = 2, Nome = "Vida e morte de M.J Gonzaga de Sá", Descricao = "Vida e morte de M.J Gonzaga de Sá é um livro que conta a história de um jornalista negro que vive no Rio de Janeiro no início do século XX, o qual aborda temas como: Desigualdade social, Racismo, Corrupção política, Abandono das populações periféricas, Burocratização do Estado.", Publicacao = "1919", AutorId = 15, Avaliacao = "4,5", Destaque = true },
    new Livro { Id = 20, FaculdadeId = 2, Nome = "No Seu Pescoço", Descricao = "No seu pescoço é um livro que aborda temas  sobre injustiça social, desigualdade de gênero, sonho, nostalgia, racismo e preconceito contra imigrantes de forma combativa, sem ser abusiva", Publicacao = "2017", AutorId = 16, Avaliacao = "4,2", Destaque = true },
    new Livro { Id = 21, FaculdadeId = 2, Nome = "Morangos mofados", Descricao = "Morangos Mofados é um livro de contos que retratam a angústia, a solidão, a repressão e a busca por liberdade de jovens na década de 1970, durante a ditadura militar no Brasil.", Publicacao = "1982", AutorId = 17, Avaliacao = "4,6", Destaque = true },
    new Livro { Id = 22, FaculdadeId = 2, Nome = "Canções Escolhidas", Descricao = "As canções escolhidas de Cartola são Alvorada, As rosas não falam, Cordas de aço, Disfarça e chora, O inverno do meu tempo, O mundo é um moinho, Que é feito de você?, Sala de recepção, Silêncio de um cipreste e Sim", Publicacao = "", AutorId = 18, Avaliacao = null, Destaque = true },
    new Livro { Id = 23, FaculdadeId = 2, Nome = "Alice no país das maravilhas", Descricao = "é uma história sobre uma menina que sonha que cai numa toca de coelho e acaba num mundo mágico. Lá, ela vive aventuras e se depara com o absurdo, o impossível e questiona tudo o que aprendeu até ali", Publicacao = "1865 ", AutorId = 19, Avaliacao = "4,8", Destaque = true },
    ...
    new Livro { Id = 26, FaculdadeId = 3, Nome = "Balada de amor ao vento", Descricao = "A obra conta a história de amor entre Sarnau e Mwando, na qual faz uma crítica à poligamia e às tradições machistas e patriarcais que afetam a vida das mulheres.", Publicacao = "1990", AutorId = 22, Avaliacao = "4", Destaque = true },
    new Livro { Id = 27, FaculdadeId = 3, Nome = "Caminho de pedras", Descricao = "Na Fortaleza dos anos 1930, durante a Era Vargas, Roberto tem a missão de recrutar operários para uma nova célula de esquerda. Uma das pessoas que se interessam é Noemi: mãe de Guri e casada com um homem que não ama mais, ela está em busca de algo que a faça se sentir viva.", Publicacao = "1937", AutorId = 23, Avaliacao = "3,5", Destaque = true },
    ...
    new Livro { Id = 29, FaculdadeId = 3, Nome = "Memórias de Martha", Descricao = "A obra narra a história de uma jovem chamada Marta, que viveu no Rio de Janeiro no final do século XIX, é uma autobiografia ficcional que retrata as dificuldades enfrentadas por Marta e sua mãe, viúva.", Publicacao = "1899", AutorId = 25, Avaliacao = "3,5", Destaque = true },
    new Livro { Id = 30, FaculdadeId = 3, Nome = "Nebulosas", Descricao = "Seus poemas revelam uma voz lírica única, que aborda temas íntimos, femininos e ligados à natureza, ao mesmo tempo em que expressam uma preocupação social evidente, especialmente em relação à abolição da escravatura, uma questão presente na sociedade brasileira do século XIX.", Publicacao = "2024", AutorId = 26, Avaliacao = "3", Destaque = true },
    new Livro { Id = 31, FaculdadeId = 3, Nome = "O cristo cigano", Descricao = "O livro é composto por uma série de poemas que contam a história de uma lenda sobre o assassinato de um cigano e a construção de uma imagem de Cristo.", Publicacao = "1961", AutorId = 27, Avaliacao = "3,7", Destaque = true },
    new Livro { Id = 32, FaculdadeId = 3, Nome = "Opúsculo Humanitário", Descricao = "A obra traça a evolução das condições femininas e mostram a experiência da autora tanto em leitura, quanto em vivências em suas viagens.", Publicacao = "1853", AutorId = 28, Avaliacao = "3,6", Destaque = true},
    };
